...
const Boxscore = () => {
    ...
    useEffect(() => {
        ...
        // converting current time to standard unix timestamp in order to perform comparision
        const date = new Date();
        ...
        .then((res) => {
            ...
            updatedAt = res.data.MLBBS[0].updatedAt
            const dbDataAge = Math.floor(Date.parse(res.data.MLBBS[0].updatedAt) / 1000);
            ...
            else if(currentTime-dbDataAge >= 15000){
