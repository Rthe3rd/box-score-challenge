...
const pitchersInfo = {
    last_name : { type: Number}, first_name : { type: Number}, display_name : { type: Number}, pitch_order : { type: Number}, win : { type: Boolean}, loss : { type: Boolean}, save : { type: Boolean}, hold : { type: Boolean}, era : { type: Number}, whip : { type: Number}, innings_pitched : { type: Number}, hits_allowed : { type: Number}, runs_allowed : { type: Number}, earned_runs : { type: Number}, walks : { type: Number}, intentional_walks : { type: Number}, strike_outs : { type: Number}, home_runs_allowed : { type: Number}, pitch_count : { type: Number}, pitches_strikes : { type: Number}, wild_pitches : { type: Number}, hit_by_pitch : { type: Number}, errors : { type: Number}, team_abbreviation : { type: Number}}
